...
import * as import2 from './match-media';
import * as import3 from './breakpoints/break-point-registry';
import * as import4 from './media-monitor';
import * as import5 from '@angular/core/src/di/injector';
import * as import6 from '@angular/core/src/zone/ng_zone';
import * as import7 from './providers/match-media-observable-provider';
import * as import8 from './providers/break-points-provider';
class MediaQueriesModuleInjector extends import0.NgModuleInjector<import1.MediaQueriesModule> {
  ...
  __MatchMediaObservable_5:any;
  constructor(parent:import5.Injector) {
    super(parent,([] as any[]),([] as any[]));
  }
  get _MatchMedia_1():import2.MatchMedia {
    if ((this.__MatchMedia_1 == null)) { (this.__MatchMedia_1 = new import2.MatchMedia(this.parent.get(import6.NgZone))); }
  ...
  get _MatchMediaObservable_5():any {
    if ((this.__MatchMediaObservable_5 == null)) { (this.__MatchMediaObservable_5 = import7.instanceOfMatchMediaObservable(this._MatchMedia_1,this._BreakPointRegistry_3)); }
    return this.__MatchMediaObservable_5;
  }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import2.MatchMediaObservable)) { return this._MatchMediaObservable_5; }
