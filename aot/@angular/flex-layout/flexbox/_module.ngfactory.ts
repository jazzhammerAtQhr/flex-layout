...
import * as import1 from './_module';
import * as import2 from '../media-query/_module';
import * as import3 from '../media-query/match-media';
import * as import4 from '../media-query/breakpoints/break-point-registry';
import * as import5 from '../media-query/media-monitor';
import * as import6 from '@angular/core/src/di/injector';
import * as import7 from '@angular/core/src/zone/ng_zone';
import * as import8 from '../media-query/providers/match-media-observable-provider';
import * as import9 from '../media-query/providers/break-points-provider';
class FlexLayoutModuleInjector extends import0.NgModuleInjector<import1.FlexLayoutModule> {
  ...
  __MatchMediaObservable_6:any;
  constructor(parent:import6.Injector) {
    super(parent,([] as any[]),([] as any[]));
  }
  get _MatchMedia_2():import3.MatchMedia {
    if ((this.__MatchMedia_2 == null)) { (this.__MatchMedia_2 = new import3.MatchMedia(this.parent.get(import7.NgZone))); }
  ...
  get _MatchMediaObservable_6():any {
    if ((this.__MatchMediaObservable_6 == null)) { (this.__MatchMediaObservable_6 = import8.instanceOfMatchMediaObservable(this._MatchMedia_2,this._BreakPointRegistry_4)); }
    return this.__MatchMediaObservable_6;
  }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import3.MatchMediaObservable)) { return this._MatchMediaObservable_6; }
